import { Activity, Hash, Play, Square, Zap } from 'lucide-react'
      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            <div
              className={`h-12 w-12 rounded-xl flex items-center justify-center ${isRunning ? 'bg-green-100' : 'bg-primary/10'}`}
            >
              {isRunning ? (
          ...
          <div className="flex items-center gap-3">
            ...
            {/* 开始/停止任务按钮 */}
            <GateButton gate={gate} onClick={onStartStop} size="sm" className="h-10 px-6">
              {isRunning ? (
                <>
