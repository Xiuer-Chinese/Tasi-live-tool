      ...
      <CardContent>
        <ScrollArea className="py-2 h-[400px]">
          <div className="space-y-1">
            {replies.length === 0 ? (
              <div className="text-center text-muted-foreground py-10">暂无回复数据</div>
            ) : (
              replies.map(reply => {
                ...
                return (
                  ...
                  <div
                    key={reply.commentId}
                    className="group px-3 py-2 text-sm hover:bg-muted/50 rounded-lg transition-all hover:-translate-y-0.5"
